...
var name = "ОМВ България ООД";
var iban = "BG09RZBB91551060202732";
var bank = "Райфайзен Банк";
var currency = "BGN";
var dealer = "Кирил Абаджиев";
var stationNumber = "1074";
var today = new Date();
function date (){
	var dd = today.getDate();
	var mm = today.getMonth()+1; //January is 0!
	var yyyy = today.getFullYear();
		if(today.getDay()){ //Sunday is 0!
			return dd + "." + mm + "." + yyyy + " г.";
		}
		else{
   	...
   	if(isTrue && arr[0][0] != '0'){
   		//arr = total.split(/[,.]/);
 			...
 			switch(arr[0][i]){
 				case "0":
 				word = "нула";
 				for(var j = 0; j < word.length; j +=1,count +=1){
...
for(var i = 0; i < currency.length; i +=1){
